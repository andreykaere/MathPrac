...
\begin{document}
    ...
    \begin{frame}
        ...
        <здесь будет продолжение про квадрику> 
        <картинка с секущими диофанта>
    \end{frame}
	...
	\begin{frame}
        ...
        \onslide<+->{
        \begin{block}{Шаг 2.}
            Случаи 1 и 2 разбираются тривиально. В третьим случае используем
            критерий Лежандра,  согласно нему уравнение 3 имеет целочисленное
            решение тогда и только тогда когда \(BC\) квадратичный вычет по
    ...
    % \begin{frame}{Сложение точек на эллиптической кривой}
    %     \begin{center}
    %         \vspace{-0.8cm} 
